...
{
    {
        ...
        results = {
            { type = "item", name = "cm-4aw_coalore", amount = 1, },
        },      
        order = "cw5", group = "railway_addons", subgroup = "yir_uranium_power_cargo4a",
    },  
    {
        type = "item-with-entity-data", name="cm-4aw_coalore", icon="__CMod__/graphics/icons/4aw_generic_icon.png", flags={"goes-to-quickbar"}, 
        group="railway_addons", subgroup="yir_uranium_power_cargo4a",
        order="cw11",
        stack_size = 10, default_request_amount = 5, icon_size = 32,
        place_result="cm-4aw_coalore",
    },
    {
        type = "cargo-wagon",
        name = "cm-4aw_coalore",
        ...
        minable = {mining_time = 1, result = "cm-4aw_coalore"},
        ...
        pictures =
        {
            ...
            direction_count = 64,
            filename = "__CMod__/graphics/4aw-cargowagons/4aw_coalore.png",
            line_length = 8,
            lines_per_file = 8,
            shift = {0.42, -1.125}
        },
