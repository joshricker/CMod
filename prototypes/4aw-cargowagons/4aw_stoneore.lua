data:extend(
{
    ...
    },
    {
        ...
        pictures =
        {
            ...
            direction_count = 64,
            filename = "__CMod__/graphics/4aw-cargowagons/4aw_stoneore.png",
            line_length = 8,
            lines_per_file = 8,
            shift = {0.42, -1.125}
        },
