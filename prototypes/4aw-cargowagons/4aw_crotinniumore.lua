data:extend(
{
    {
        type = "recipe",
        name = "cm-4aw_crotinniumore_recipe",
        category = "yir_rc_wsw",
        enabled = "true",
    ...
    },
    {
        ...
        pictures =
        {
            ...
            direction_count = 64,
            filename = "__CMod__/graphics/4aw-cargowagons/4aw_crotinniumore.png",
            line_length = 8,
            lines_per_file = 8,
            shift = {0.42, -1.125}
        },
