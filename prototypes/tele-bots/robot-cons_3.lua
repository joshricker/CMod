...
-- Item
  ...
  },
 {
  ...
  },
  {
    ...
    minable = {hardness = 0.1, mining_time = 0.1, result = "cm-construction-robot-3"},
    max_health = 500,
    ...
    idle =
    {
      filename = "__CMod__/graphics/icons/icon_cm_construction-robot_3.png",
      priority = "high",
      line_length = 16,
      width = 32,
      height = 36,
    ...
    working =
    {
      filename = "__CMod__/graphics/icons/icon_cm_construction-robot-working_3.png",
      priority = "high",
      line_length = 2,
      width = 28,
      height = 36,
