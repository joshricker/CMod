...
if data.raw.item["put-chest"] then
  data.raw["container"]["put-chest"].inventory_size = 2000
  data.raw["logistic-container"]["get-chest"].inventory_size = 2000
  data.raw.recipe["put-electricity"].ingredients =  {{"steel-chest", 1},{"electronic-circuit", 50}}
  data.raw.recipe["get-electricity"].ingredients =  {{"steel-chest", 1},{"electronic-circuit", 50}}
end
