...
--data.raw["ammo"]["firearm-magazine"]["ammo_type"].action ={{type = "direct",action_delivery ={{type = "instant",source_effects ={{type = "create-explosion",entity_name = "explosion-gunshot"}},target_effects = {{ type = "create-entity",entity_name = "explosion-hit" }, {type = "damage",damage = { amount = 4,type = "physical"}}}}}}}
data.raw["ammo"]["piercing-rounds-magazine"].magazine_size = 50
--data.raw["ammo"]["piercing-rounds-magazine"]["ammo_type"].action ={{type = "direct",action_delivery ={{type = "instant",source_effects ={{type = "create-explosion",entity_name = "explosion-gunshot"}},target_effects = {{ type = "create-entity",entity_name = "explosion-hit" }, {type = "damage",damage = { amount = 8,type = "physical"}}}}}}}
...
data.raw["fluid-wagon"]["fluid-wagon"].total_capacity = 100000 * 3
...
data.raw["locomotive"]["locomotive"].equipment_grid = "large-equipment-grid"
data.raw["car"]["car"].equipment_grid = "large-equipment-grid"
data.raw["car"]["tank"].equipment_grid = "large-equipment-grid"
...
if data.raw["assembling-machine"]["y-crusher"] then
	...
	data.raw["recipe"]["y_mc_e2_mining_drill_recipe"].ingredients = {{"y-mining-drill-e2",1},{"y_rwtechsign",350},}

--	data.raw["generator"]["y-steam-turbine"].fluid_usage_per_tick = 1.3728
--	data.raw["generator"]["y_steam_turbine_mc"].fluid_usage_per_tick = 3.432
...
if data.raw["recipe"]["yir_coins_gen1_recipe"] then
	...
	require("prototypes.equipment.train-equipment")
end
...
data:extend({
	{
	type = "equipment-grid",
	name = "train-large-equipment-grid",
	width = 12,
	height = 12,
	equipment_categories = {"armor", "train", "farl-equipment"}
	},
})

if data.raw["car"]["heli-entity-_-"] then
	data.raw["car"]["heli-entity-_-"].equipment_grid = "train-large-equipment-grid"
	data.raw["car"]["heli-entity-_-"].max_health = 7500
	data.raw["car"]["heli-placement-entity-_-"].equipment_grid = "train-large-equipment-grid"
	data.raw["car"]["heli-placement-entity-_-"].max_health = 7500
	data.raw["car"]["heli-flying-collision-entity-_-"].equipment_grid = "train-large-equipment-grid"
	data.raw["car"]["heli-body-entity-_-"].equipment_grid = "train-large-equipment-grid"
	data.raw["car"]["heli-shadow-entity-_-"].equipment_grid = "train-large-equipment-grid"
	data.raw["car"]["heli-burner-entity-_-"].equipment_grid = "train-large-equipment-grid"
end